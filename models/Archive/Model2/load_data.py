...
class DataSet(object):
    ...
    def __init__(self, X, Y, config):
        ...
        self._X = X
        self._Y = Y
        self._features = self.X.as_matrix()
        self._targets = np.reshape(self.Y.values, newshape=len(Y))
    ...
    def prepBatches(self, batch_size, num_steps):
    ...
    def __iter__(self):
        ...
        if not (self.batch_size and self.num_steps):
            yield None
